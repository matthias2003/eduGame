...
void Tavern() {
    ...
    std::vector<std::string> options = { "Game guide","Question hints","Random question","Back" };
    ...
    while(again) {
        ...
        switch(input) {
            case 1:
                std::cout << "Rules are simple! Fight your way trough enemies to victory! You have 4 options." << std::endl
                << "Character -> place where you can upgrade your stats and see them, your xp and level progress" << std::endl
                << "Story -> you face up with greatest enemies of the whole world, fighting to claim the glory. \n But you have to be cautious."
                << "If you die there, you lose everything, and start from the beginning." << std::endl
                << "Arena -> fight to gain Xp and gold to level up and face bigger threats in Story mode. \n"
                << "If you die, you only need to pay your medical bills, which is all of your gold" << std::endl
                << "Tavern -> grab a seat and enjoy. The game guide (which you are reading right now) will help you understand the game. \n"
                << "Question hints gives to advices how to approach questions. Random questions allows you to train before fights" << std::endl
